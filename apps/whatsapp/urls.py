...
urlpatterns = [
    ...
    path("templates/lint/", views.template_lint, name="whatsapp-template-lint"),
    path("templates/media/upload/", views.template_media_upload, name="whatsapp-template-media-upload"),
    path("codes/", views.codes_setup, name="whatsapp-codes"),
    path("codes/key/", views.codes_key_create, name="whatsapp-codes-key"),
