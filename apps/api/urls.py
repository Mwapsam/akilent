...
urlpatterns = [
    ...
    path("<str:version>/templates/<slug:slug>/locales", views.TemplateLocalesView.as_view(), name="api-v1-template-locales"),
    path("<str:version>/templates/<slug:slug>/locales/<str:locale>", views.TemplateLocaleDetailView.as_view(), name="api-v1-template-locale-detail"),
    path("<str:version>/templates/<slug:slug>/data-sources", views.TemplateDataSourcesView.as_view(), name="api-v1-template-data-sources"),
    path("<str:version>/templates/<slug:slug>/data-sources/<str:key>", views.TemplateDataSourceDetailView.as_view(), name="api-v1-template-data-source-detail"),
